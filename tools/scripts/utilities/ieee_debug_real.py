    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            access_indicators = {
                ...
                "abstract_only": "abstract" in content.lower()
                and "full text" not in content.lower(),
            ...
            try:
                ...
                username_input = await page.wait_for_selector(
                    'input[name="j_username"]', timeout=15000
                )
                await username_input.fill(username)

                password_input = await page.wait_for_selector(
                    'input[name="j_password"]', timeout=5000
                )
                ...
                has_pdf_access = (
                    "download pdf" in final_content.lower() or "view pdf" in final_content.lower()
                )
