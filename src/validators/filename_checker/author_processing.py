...
def fix_initial_spacing(author_part: str) -> str:
    ...
    """
    # One implementation, in core.initials. This module and
    # validators/author_parser.py each used to carry their own, and neither
    # was a superset of the other: this one missed a final initial that had
    # lost its period ("Kyprianou, A.E"), that one missed multi-letter
    # initials ("Kabanov, Yu.A.") because it was ASCII-only.
